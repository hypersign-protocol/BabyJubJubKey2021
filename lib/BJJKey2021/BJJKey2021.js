    ...
    static fromKeys(options) {
        ...
        if (privateKeyMultibase) {
            ...
            return new BabyJubJubKeys2021({
                ...
                id: (_a = options.options) === null || _a === void 0 ? void 0 : _a.id,
                controller: (_b = options.options) === null || _b === void 0 ? void 0 : _b.controller,
            });
        }
        else {
            return new BabyJubJubKeys2021({
                publicKey: js_crypto_1.PublicKey.newFromHex(publicKey),
                id: (_c = options.options) === null || _c === void 0 ? void 0 : _c.id,
                controller: (_d = options.options) === null || _d === void 0 ? void 0 : _d.controller,
            });
        }
    }
